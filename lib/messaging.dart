...
//       print(
//           'http://www.matajerplus-om.com/api/fire/userId&$peerId/title&$notiTit/body&${notiBody}datatitle&$dataTit/databody&$dataBody');
...
//       if (!isImage) {
//         sendNoti(content, userName, content, userName);
//       }
//       isImage = false;
//     } else {
...
//           border: new Border(
//               top: new BorderSide(color: Colors.lightGreen, width: 0.5)),
//           color: Colors.white),
...
//           //       onPressed: sendRecipt, //getSticker,
//           //       color: Color(0xff34C961),
//           //     ),
//           //   ),
//           //   color: Colors.white,
...
//               child: TextField(
//                 textAlign: TextAlign.right,
//                 style: TextStyle(color: Color(0xff34C961), fontSize: 15.0),
...
//           ? Center(
//               child: CircularProgressIndicator(
//                   valueColor: AlwaysStoppedAnimation<Color>(Color(0xff34C961))))
//           : StreamBuilder(
